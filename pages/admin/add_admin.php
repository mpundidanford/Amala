...
$user_check = "SELECT * FROM user_admin WHERE username = '$username'";
$result1 = mysqli_query($conn, $user_check);
...
if(count($error)==0){
  ...
  $sql = "INSERT INTO `user_admin`(`id`, `firstname`, `lastname`, `email`, `username`, `password`)
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="#" class="d-block">Danford</a>
        </div>
      </div>
      <!-- Sidebar Menu -->
      <nav class="mt-2">
    ...
    <div class="container">
     <div class="container d-flext justify-content-center"> 
       <form action="add_admin.php" method="post" style="width:50vw; min-width: 300px;">
          ...
          <button class="btn btn-success" name="add_admin" type="sumbit">Save</button>
